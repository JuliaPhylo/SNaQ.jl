...
import SNaQ: 
    ...
    findquartetequations, computelossandgradient!, computeSNaQscore!,
...
@testset "computelossandgradient! calculation" begin
    ...
    for i in 1:length(params)
        ...
        loss_plus = computeSNaQscore!(qdata, params_plus, q)
        loss_minus = computeSNaQscore!(qdata, params_minus, q)
