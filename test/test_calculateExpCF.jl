...
# include(joinpath(dirname(pathof(SNaQ)),  "..","examples","case_g_example.jl"))
error1 = false
ind = 0
...
# include(joinpath(dirname(pathof(SNaQ)),  "..","examples","case_f_example.jl"))
error1 = false
ind = 0
parameters!(net)
...
# include(joinpath(dirname(pathof(SNaQ)),  "..","examples","case_i_example.jl"))
error1 = false
ind = 0
