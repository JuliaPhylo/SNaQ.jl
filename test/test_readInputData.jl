...
# nexusfile = joinpath(dirname(pathof(SNaQ)), "..","examples","test_reticulatetreeblock.nex")
...
@test df2 == (
  ...
  CF12_34=[1.0,0.75,1.0,0.75,1.0,0.75,0.0,0.0,(3+4)/11,(3+4)/11,1.0],
  CF13_24=[0,0.25,0,0.25,0,0,0,0,(2+2)/11,(2+2)/11,0.0],
  CF14_23=[0,0,0,0,0,0.25,1,1,0,0,0],
  ngenes=Union{Missing,Float64}[5,4,5,4,5,4,11,11,11,11,6]
)
end