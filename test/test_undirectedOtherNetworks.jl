...
net = readnewick_level1("(4:1.0,(3:1.0,((1:1.0,2:1.0):1.87)#H7:10.0::0.51):0.042,(5:1.0,(#H7:10.0::0.49,6:1.0):10.0):1.183);");
out = "4"
checkNet(net)
otherNet1 = undirectedOtherNetworks(net, insideSnaq=true);
length(otherNet1) == 4 || error("wrong number of other networks")
...
net = readnewick_level1("(6,((5,#H7:0.0::0.29999):10.0,(((2,#H9:0.0::0.15902):0.02332,(1,(3)#H9:0.9417::0.84098):0.12997):1.2018,(4)#H7:0.01722::0.70001):9.99428):0.24593);");
out = "6"
checkNet(net)
otherNet1 = undirectedOtherNetworks(net, insideSnaq=true);
