...
@test isvalidrSPR(get_nodes(net, "i1", "i3", "i6", "i2", "i4", "i5")...)
@test !isvalidrSPR(get_nodes(net, "i1", "i3", "i6", "i2", "i5", "i4")...)
...
applymove!(net, :rSPR, (w, x, y, z, xprime, yprime))

w, x, y, z, xprime, yprime = get_nodes(net, "i1", "i3", "i6", "i2", "i4", "i5")
performrSPR!(net, w, xprime, yprime, z, x, y)
...
performrSPR!(net, w, x, y, z, xprime, yprime)
w, x, y, z, xprime, yprime = get_nodes(net, "i6", "i3", "i5", "i4", "i2", "i1")
performrSPR!(net, w, xprime, yprime, z, x, y)
...
for j = 1:1000
    ...
    params = samplerSPRparameters(net, rng)
    performrSPR!(net, params...)
