...
newH = add_hybrid!(net, e2, e1);
remove_hybrid!(net, newH)
...
@test_nowarn move_reticulate_origin!(net, sample_move_reticulate_origin_parameters(net, Random.seed!(0))...);
...
samp = sample_move_reticulate_origin_parameters(net, Random.seed!(0))
@test samp !== nothing
