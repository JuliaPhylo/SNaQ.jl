...
# function shrinkbaddiamonds!(N::HybridNetwork)
...
#             if n3_ge2
#                 n1_subtree_node = getothernodes(fourth_node, p_major, p_minor)[1]
#                 n1_ge2 = !n1_subtree_node.leaf && length(getothernodes(n1_subtree_node, fourth_node)) > 1
#                 n1_ge2 && continue  # this is a good diamond
#             end

#             # 3. check (2) failed, now check if n1>=2 OR n0>=2
#             n2_subtree_node = getothernodes(p_major, fourth_node, H)[1]
#             n2_ge2 = !n2_subtree_node.leaf && length(getothernodes(n2_subtree_node, p_major)) > 1
#             n2_ge2 && continue  # good diamond
            
#             n0_subtree_node = getothernodes(p_minor, fourth_node, H)[1]
#             n0_ge2 = !n0_subtree_node.leaf && length(getothernodes(n0_subtree_node, p_minor)) > 1
...
function getothernodes(n::Node, except_nodes::Node...)
